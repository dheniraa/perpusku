    ...
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box">
        ...
        style="font-family: Poppins, sans-serif">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link px-md-4" href="{{ route('perpusku.book.index') }}">Buku</a>
                </li>
                <li class="nav-item">
                <a class="nav-link px-md-4" href="{{ route('perpusku.borrow.index') }}">Peminjaman</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex">
                <form action="{{ route('auth.logout') }}" onsubmit="return confirm('Yakin mau Logout ?')" method="post">
                    @csrf
			...
			<div class="border-color info-footer">
				...
				<div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					...
					<nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style="margin: 0">Copyright © 2024 E-Library</p>
					</nav>
				</div>
			</div>
		</div>
